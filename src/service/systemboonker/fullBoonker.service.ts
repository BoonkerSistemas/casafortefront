...
export class FullBoonkerService {
    constructor() {
    }

    async getComponentSlider() {
        const url: string = `${environment.api_url}/sistema-boonker?[populate]=*`;
        const headers = {
    ...
    async getComponentBotones(home: string) {
        ...
        const url: string = `${environment.api_url}/sistema-boonker?populate[${home}][populate]=*`;
    ...
    async getComponentOnlyButtons(home: string) {
        ...
        const url: string = `${environment.api_url}/sistema-boonker?populate[${home}][populate]=Button.icon`;
    ...
    async getComponentImage(home: string) {
        ...
        const url: string = `${environment.api_url}/sistema-boonker?populate[${home}][populate]=image.file`;
    ...
    async getComponentList(home: string) {
        ...
        const url: string = `${environment.api_url}/sistema-boonker?populate[${home}][populate]=listado.icon`;
