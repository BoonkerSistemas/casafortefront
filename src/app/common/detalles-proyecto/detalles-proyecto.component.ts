...
export class DetallesProyectoComponent implements OnInit {
    ...
    tiemposEjecucion = [
        { seccion: 'Sección 1', tiempo: '2 horas' },
        { seccion: 'Sección 2', tiempo: '1.5 horas' },
        { seccion: 'Sección 3', tiempo: '3 horas' },
        { seccion: 'Sección 4', tiempo: '2.5 horas' }
      ];
    
      // Datos para la galería de imágenes
      imagenes = [
        { url: 'images/blog-details.jpg', titulo: 'Imagen 1' },
        { url: 'images/blog-details.jpg', titulo: 'Imagen 2' },
        { url: 'images/blog-details.jpg', titulo: 'Imagen 3' },
        { url: 'images/blog-details.jpg', titulo: 'Imagen 4' },
        { url: 'images/blog-details.jpg', titulo: 'Imagen 5' },
        { url: 'images/blog-details.jpg', titulo: 'Imagen 6' }
      ];
