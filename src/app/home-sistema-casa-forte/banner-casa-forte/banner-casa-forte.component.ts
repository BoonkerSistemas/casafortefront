...
@Component({
    selector: 'app-banner-casa-forte',
    imports: [
        CarouselModule,
        NgForOf,
        NgIf,
    ],
    templateUrl: './banner-casa-forte.component.html',
    styleUrl: './banner-casa-forte.component.scss'
})
export class BannerCasaForteComponent {
    ...
    constructor(
        ...
        private _firstComponentService: SystemCasaForteService,
