...
@Component({
    selector: 'app-preguntas-frecuentes-boonker',
    imports: [NgClass, NgForOf, MarkdownPipe],
    templateUrl: './preguntas-frecuentes-boonker.component.html',
    styleUrls: ['./preguntas-frecuentes-boonker.component.scss']
})
export class PreguntasFrecuentesBoonkerComponent implements OnInit{
