...
@Component({
    selector: 'app-services-muros-contencion',
    imports: [
        NgForOf
    ],
    templateUrl: './services-muros-contencion.component.html',
    styleUrls: ['./services-muros-contencion.component.scss']
})
export class ServicesMurosContencionComponent implements OnInit, AfterViewInit {
    title = 'Welcome';
    description = 'Welcome';
    content = 'Welcome';
    lists: any[] = [];
