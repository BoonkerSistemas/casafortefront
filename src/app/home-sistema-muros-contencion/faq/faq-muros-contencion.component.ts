...
@Component({
    selector: 'app-faq-muros-contencion',
    imports: [NgClass, NgForOf, MarkdownPipe],
    templateUrl: './faq-muros-contencion.component.html',
    styleUrls: ['./faq-muros-contencion.component.scss']
})
export class FaqMurosContencionComponent implements OnInit{
